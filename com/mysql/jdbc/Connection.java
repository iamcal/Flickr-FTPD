 ...
 * @version $Id: Connection.java,v 1.31.2.49 2004/01/13 21:56:18 mmatthew Exp $
 *
...
public class Connection implements java.sql.Connection {
    ...
    Connection(String host, int port, Properties info, String database,
        ...
        if (database == null) {
            throw new SQLException("Malformed URL '" + url + "'.", SQLError.SQL_STATE_GENERAL_ERROR);
        }
        ...
        try {
            ...
            throw new java.sql.SQLException(mesg.toString(), SQLError.SQL_STATE_COMMUNICATION_LINK_FAILURE);
        }
    }
        ...
        if (this.transactionsSupported) {
            ...
            if ((autoCommit == false) && (this.relaxAutoCommit == false)) {
                throw new SQLException("MySQL Versions Older than 3.23.15 "
                    + "do not support transactions", SQLError.SQL_STATE_DRIVER_NOT_CAPABLE);
            } else {
                this.autoCommit = autoCommit;
            }
        }
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    throw new SQLException(
                        ...
                        + " to a valid JDBC level.", SQLError.SQL_STATE_GENERAL_ERROR);
                } else {
                ...
                try {
                    ...
                    if ((hostListSize - 1) == hostIndex) {
                        throw new SQLException(
                            ...
                            + unknownException.toString(), SQLError.SQL_STATE_COMMUNICATION_LINK_FAILURE);
                    }
                }
            }
        } else {
            ...
            for (int hostIndex = 0; hostIndex < hostListSize; hostIndex++) {
                ...
                if (!connectionGood) {
                    ...
                    throw new SQLException(
                        ...
                        + connectionException + "'.\nAttempted reconnect "
                        + this.maxReconnects + " times. Giving up.", SQLError.SQL_STATE_UNABLE_TO_CONNECT_TO_DATASOURCE);
                }
            }
        }
        ...
        if (this.mysqlEncodingName != null) {
            ...
            try {
                ...
                throw new SQLException(
                    ...
                    + "to your JDBC URL.", SQLError.SQL_STATE_INVALID_CONNECTION_ATTRIBUTE);
            }
        }
    }
    ...
    private void initializeDriverProperties(Properties info)
            ...
            try {
                ...
                if (seconds < 1) {
                    throw new SQLException("Illegal (< 1)  value '"
                        ...
                        + "' for 'secondsBeforeRetryMaster'", SQLError.SQL_STATE_ILLEGAL_ARGUMENT);
                }
        ...
        if (info.getProperty("queriesBeforeRetryMaster") != null) {
            ...
            try {
                ...
                throw new SQLException("Illegal non-numeric value '"
                    ...
                    + "' for 'queriesBeforeRetryMaster'", SQLError.SQL_STATE_ILLEGAL_ARGUMENT);
            }
        }
            ...
            if (info.getProperty("maxReconnects") != null) {
                try {
                    ...
                    throw new SQLException("Illegal parameter '"
                        ...
                        + "' for maxReconnects", SQLError.SQL_STATE_INVALID_CONNECTION_ATTRIBUTE);
                }
            }
            ...
            if (info.getProperty("initialTimeout") != null) {
                try {
                    ...
                    throw new SQLException("Illegal parameter '"
                        ...
                        + "' for initialTimeout", SQLError.SQL_STATE_INVALID_CONNECTION_ATTRIBUTE);
                }
            }
        }
        ...
        if (info.getProperty("maxRows") != null) {
            try {
                ...
                throw new SQLException("Illegal parameter '"
                    + info.getProperty("maxRows") + "' for maxRows", SQLError.SQL_STATE_INVALID_CONNECTION_ATTRIBUTE);
            }
        }
            ...
            if (info.getProperty("characterEncoding") != null) {
                ...
                try {
                    ...
                    throw new SQLException("Unsupported character "
                        + "encoding '" + this.encoding + "'.", SQLError.SQL_STATE_INVALID_CONNECTION_ATTRIBUTE);
                }
            }
        }
    }
            ...
            if (this.useTimezone
                ...
                if ((canoncicalTimezone == null)
                    ...
                    try {
                        ...
                        throw new SQLException(iae.getMessage(), SQLError.SQL_STATE_GENERAL_ERROR);
                    }
                }
                ...
                if (!canoncicalTimezone.equalsIgnoreCase("GMT")
                    ...
                    throw new SQLException("No timezone mapping entry for '"
                        + canoncicalTimezone + "'", SQLError.SQL_STATE_ILLEGAL_ARGUMENT);
                }
            }
